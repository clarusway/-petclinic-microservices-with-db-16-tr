...
AWS_REGION=$AWS_REGION helm repo add o-petclinic s3://petclinic-helm-charts-o/stable/myapp/ || echo "repository name already exists"
AWS_REGION=$AWS_REGION helm repo update
helm package k8s/petclinic_chart
AWS_REGION=$AWS_REGION helm s3 push --force petclinic_chart-${BUILD_NUMBER}.tgz o-petclinic
...
AWS_REGION=$AWS_REGION helm upgrade --install \
    petclinic-app-release o-petclinic/petclinic_chart --version ${BUILD_NUMBER} \
